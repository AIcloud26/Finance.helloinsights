...
function generateFallbackContent(category, topic, editorialInput) {
  ...
  var sections = [
    ...
    "The discussion around " + topic + " has attracted attention across financial markets. However, the deeper story is more complex than the initial headline. Understanding the forces behind this development can help investors, businesses and consumers evaluate what may happen next.",

    "The financial impact is rarely determined by one factor alone. Market reactions usually reflect changing expectations, business conditions and assumptions about future growth.",

    "Investors often need to separate short-term sentiment from longer-term fundamentals. A strong market reaction does not always mean the underlying opportunity or risk has been fully understood.",

    "Companies responding to changes in " + topic + " must balance opportunity with uncertainty. Strategic decisions depend on customer demand, operating costs, competition and broader economic conditions.",

    "Consumers may experience the effects differently depending on their financial position and priorities. Changes in markets or business strategies can influence everyday decisions over time.",

    "Another important consideration is whether current expectations are realistic. Markets can sometimes price future possibilities before clear evidence appears.",

    "For investors, the key question is which assumptions could change. Growth, regulation, consumer behavior and economic conditions can all influence future outcomes.",

    "Businesses also need to evaluate whether this development represents a temporary adjustment or a longer-term structural change.",

    humanView 
      ? "Editorial perspective: " + humanView
      : "The broader impact will depend on how different participants respond as conditions continue to evolve.",

    "Future developments will depend on real-world results rather than headlines alone. Careful analysis remains important because opportunities and risks often exist at the same time."
  ];


  return sections.map(function(p){
    return "<p>" + p + "</p>";
  }).join("\n");
