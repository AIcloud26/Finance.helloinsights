...
"EDITORIAL DIRECTION: " + (editorialInput.direction || "Independent editorial analysis"),
    ...
    "",
    "STYLE RULES:",
    "- Write like an experienced financial journalist or market analyst.",
    "- Avoid generic AI-style introductions and predictable article structures.",
    "- Do not start with broad statements or definitions.",
    "- Open with a specific market event, company action, product change, regulation, economic signal or real-world situation.",
    "- Avoid phrases such as 'This article', 'This guide', 'In this article', 'A comprehensive look at', 'In conclusion', or 'It is important to note'.",
    "- Use varied sentence structures and natural paragraph lengths.",
    "- Avoid repetitive transitions, formulaic headings and artificial summaries.",
    "- Explain why developments matter, including opportunities, risks and uncertainty.",
    "- Provide analysis rather than simply describing facts.",
    "- Do not invent statistics, quotes, studies, companies, analyst opinions or sources.",
    "- If information is uncertain, clearly express uncertainty instead of creating unsupported claims.",
    "- End with forward-looking analysis rather than a generic conclusion.",
    "",
    "OUTPUT:",
